...
# --- Add OpenCC (Traditional to Simplified) converter ---
    ...
    def _docs_iter(self):
        with self._dlc.stream() as stream:
            for line in stream:
                ...
                # --- Apply Chinese normalization to corpus fields ---
                ...
                yield TrecToTDoc(
                    ...
                    # Convert title and text to Simplified Chinese
                    title=cc.convert(title_raw) if title_raw else None,
                    text=cc.convert(text_raw) if text_raw else None,
    ...
    def queries_iter(self):
        with self._dlc.stream() as stream:
            for line in stream:
                ...
                # --- Apply Chinese normalization to query fields ---
                ...
                yield TrecToTQuery(
                    ...
                    # Convert title and query text to Simplified Chinese
                    title=cc.convert(title_raw) if title_raw else None,
                    text=cc.convert(query_raw) if query_raw else None
                )
